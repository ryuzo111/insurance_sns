...
@endif
<p class="post-container2-p">どんなタイプの悩み</br>
...
<div class="post-container2">
<p>もし保険を探しているなら、どんな保険を探している?※探している人のみ</br>
...
<input class="post-text" type="text" name="insurance_value" placeholder="旦那の生命保険を500万円備えたい">
</div>
...
<input class="post-text" type="text" name="contents" placeholder="子供が生まれました。保険に入るべきなのか？また、入ったほうが良いならどんな保険に入ると良いのか？教えて下さい" required>
</div>
